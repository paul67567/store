...
func (bt EthereumTransaction) PartialRefund(t Transaction, comment, userUuid string, refundPercent float64) error {
	...
	storeAddress := store.EthereumAddress()
	buyerAddress := buyer.EthereumAddress()
	resolverAddress := resolver.EthereumAddress()
