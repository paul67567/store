...
type ViewMessage struct {
	*Message
	...
	ViewSenderUser   ViewUser      `json:"sender"`
	ViewReceiverUser ViewUser      `json:"receiver"`
}
...
func (m Message) ViewMessage(lang string) ViewMessage {
	vm := ViewMessage{
		...
		ViewSenderUser:   m.SenderUser.ViewUser(lang, true),
		ViewReceiverUser: m.RecieverUser.ViewUser(lang, true),
	}
...
func (t Thread) ViewThread(lang string, reciever *User) ViewThread {
	...
	// viewThread.ViewSenderUser = t.SenderUser.ViewUser(lang, false)
	// viewThread.ViewReceiverUser = t.RecieverUser.ViewUser(lang, false)
